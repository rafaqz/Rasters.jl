...
ga3 = GeoArray(rand(10, 41, 91), (Vert(100:100:1000), Y(-20.0:1.0:20.0), X(0.0:4.0:360.0)))
ga4ti = GeoArray(
    rand(10, 41, 91, 4), 
    (Vert(100:100:1000), Y(-20.0:1.0:20.0), X(0.0:4.0:360.0), Ti(Date(2001):Year(1):Date(2004)))
)
ga4x = GeoArray(
    rand(10, 41, 91, 4), 
    (Vert(100:100:1000), Y(-20.0:1.0:20.0), X(0.0:4.0:360.0), X())
)
