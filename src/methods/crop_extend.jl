...
savefig("docs/build/.documenter/nz_crop_example.png")
nothing
...
savefig("docs/build/.documenter/argentina_crop_example.png"); nothing
...
savefig("docs/build/.documenter/extend_example.png")
nothing
# output
```
