...
savefig("src/assets/api/nz_crop_example.png")
nothing

# output
```

![new zealand evenness cropped](assets/api/nz_crop_example.png)
...
savefig("src/assets/api/argentina_crop_example.png"); nothing

# output
```

![argentina evenness cropped](assets/api/argentina_crop_example.png)
...
savefig("src/assets/api/extend_example.png")
nothing
# output
```

![extend](assets/api/extend_example.png)
