...
function _precompile(::Type{NCDfile})
    ...
    precompile(_dsdim, (NCDatasets.NCDataset{Nothing}, Symbol, Nothing, Nothing))
    precompile(_dsdim, (NCDatasets.NCDataset{Nothing}, Symbol, Nothing, EPSG))
    precompile(_dsdim, (NCDatasets.NCDataset{Nothing}, Symbol, EPSG, EPSG))
